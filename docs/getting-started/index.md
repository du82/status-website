...
- [**Sign into** your Status profile on a new device](../your-profile-and-preferences/sign-into-your-status-profile-on-a-new-device)
- [**Add a contact** in Status](../your-profile-and-preferences/add-a-contact-in-status)
- [**Join** a Status Community](../status-communities/join-a-status-community)
- [**Invite friends** to Status](./invite-friends-to-status)
- [**Status Wallet**: your quick start guide](../status-wallet/status-wallet-your-quick-start-guide)
- [Secure your **information and funds**](../your-profile-and-preferences/secure-your-information-and-funds)

## Getting started with your community

- [**Create** a Status Community](../status-communities/create-a-status-community)
- [About Status **Web Communities**](../status-communities/about-status-web-communities)
