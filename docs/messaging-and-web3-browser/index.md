...
- [**Share** your Status **profile**](../your-profile-and-preferences/share-your-status-profile)
...
- [**Add people** to a direct message](./dd-people-to-a-direct-message)
...
- [Enable **rich link previews** in messages](../your-profile-and-preferences/enable-rich-link-previews-in-messages)
- [**Use mentions** in Status](./use-mentions-in-status)
- [**Mute** your notifications](../your-profile-and-preferences/mute-your-notifications)
...
- [Set the **default browser** in Status](../your-profile-and-preferences/set-the-default-browser-in-status)
